...
class Checkpoint:
    ...
    Args:
        pipeline_id: Unique UUID v4 for this pipeline run.
        started_at: ISO 8601 timestamp of pipeline start.
        finished_at: ISO 8601 timestamp of pipeline end (or None).
        status: Pipeline stage value (not_running, running, completed, failed).
