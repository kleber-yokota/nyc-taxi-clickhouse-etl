...
from etl.orchestrator import adapt_s3_to_manifest
from push.core.push_manifest import S3Object


class TestAdaptS3ToManifest:
    """Tests for adapt_s3_to_manifest function."""
    ...
    def test_adapt_single_object(self) -> None:
        ...
        result = adapt_s3_to_manifest(s3_objects, prefix="data")
    ...
    def test_adapt_respects_prefix(self) -> None:
        ...
        result = adapt_s3_to_manifest(s3_objects, prefix="mydata")
    ...
    def test_adapt_empty_list(self) -> None:
        ...
        result = adapt_s3_to_manifest([], prefix="data")
        assert result == {}
