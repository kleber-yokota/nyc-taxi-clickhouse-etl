...
class TestHandleDownloadErrorUnknown:
    """Test handle_download_error with unknown exceptions."""

    def test_value_error_logs_unknown_error(self):
        """Verify non-HTTP/network exceptions log UNKNOWN."""
        entry = CatalogEntry("yellow", 2024, 1)
        state = MagicMock()
        known_missing = MagicMock()
    ...
    def test_runtime_error_logs_unknown_error(self):
        """Verify RuntimeError logs UNKNOWN."""
        entry = CatalogEntry("yellow", 2024, 1)
        state = MagicMock()
        known_missing = MagicMock()
    ...
    def test_unknown_error_logs_message(self, caplog: pytest.LogCaptureFixture):
        """Verify unknown error logs the exception message."""
        entry = CatalogEntry("yellow", 2024, 1)
        state = MagicMock()
        known_missing = MagicMock()
    ...
    def test_unknown_error_does_not_add_known_missing(self):
        """Verify unknown errors do not add to known_missing."""
        entry = CatalogEntry("yellow", 2024, 1)
        state = MagicMock()
        known_missing = MagicMock()
