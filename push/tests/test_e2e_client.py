...
class TestS3ClientMethods:
    ...
    def test_put_and_head_object(self, s3_client: S3Client) -> None:
    ...
    def test_list_objects_empty(self, s3_client: S3Client) -> None:
        s3_client.create_bucket()
        objects = s3_client.list_objects("data")
        assert objects == []

    def test_list_objects_with_files(self, s3_client: S3Client) -> None:
        s3_client.create_bucket()
    ...
    def test_delete_object(self, s3_client: S3Client) -> None:
        s3_client.create_bucket()
    ...
    def test_create_bucket_exists(self, s3_client: S3Client) -> None:
        s3_client.create_bucket()
        s3_client.create_bucket()

    def test_build_key_with_prefix(self, s3_client: S3Client) -> None:
