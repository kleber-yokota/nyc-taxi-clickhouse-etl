...
class TestListS3Objects:
    ...
    def test_returns_empty_list_when_no_objects(self, mock_from_env) -> None:
    ...
    @patch("push.core.push_manifest.S3Client.from_env")
    def test_returns_s3_objects_list(self, mock_from_env) -> None:
    ...
    @patch("push.core.push_manifest.S3Client.from_env")
    def test_uses_custom_prefix(self, mock_from_env) -> None:
    ...
    @patch("push.core.push_manifest.S3Client.from_env")
    def test_creates_client_with_bucket_and_prefix(self, mock_from_env) -> None:
